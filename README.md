...
34. Create a model to answer the following question: *How many orders were placed in total?*

35. Create a model to answer the following question: *How many orders were placed by day?*

36. Create a model to answer the following question: *How many orders were placed in each store in total?*

37. Create a model to answer the following question: *What are the top 10 customers by number of orders placed?*

38. Create a model to answer the following question: *How many items were sold by day?*

39. Delete the Google Project.

40. Delete the GitHub repository.

41. Delete your local dbt project folder.
