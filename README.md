...
27. Add the `dbt_utils` package to your project, and run the appropriate command to install it.
...
28. Add relevant data tests for the staging model containing customers.

29. Add relevant data tests for the staging model containing orders.

30. Add relevant data tests for the staging model containing order items.

31. Add relevant data tests for the staging model containing stores.

32. Add relevant data tests for the staging model containing supplies.

33. Add relevant data tests for the staging model containing products.

34. Add a model that contains all dates between the first order date and the current date. Name this model `dim_dates`.

35. Create a marts model to calculate the total number of orders placed by day for each store.

36. Add a new column to calculate the revenue by day for each store.

37. Add a new column to calculate the number of items sold by day for each store.

38. Create an analysis file to answer the following question: *How many orders were placed in total?*

39. Create an analysis file to answer the following question: *How many orders were placed by day?*

40. Create an analysis file to answer the following question: *How many orders were placed in each store in total?*

41. Create an analysis file to answer the following question: *What are the top 10 customers by number of orders placed?*

42. Create an analysis file to answer the following question: *How many items were sold by day?*

43. Delete the Google Project.

44. Delete the GitHub repository.

45. Delete your local dbt project folder.
