...
18. Create a model to answer the following question: *How many orders were placed in total?*

19. Create a model to answer the following question: *How many orders were placed by day?*

20. Create a model to answer the following question: *How many orders were placed in each store in total?*

21. Create a model to answer the following question: *What are the top 10 customers by number of orders placed?*

22. Create a model to answer the following question: *How many items were sold by day?*

23. Delete the Google Project.

24. Delete the GitHub repository.

25. Delete your local dbt project folder.
