...
24. Create a model to answer the following question: *How many orders were placed in total?*

25. Create a model to answer the following question: *How many orders were placed by day?*

26. Create a model to answer the following question: *How many orders were placed in each store in total?*

27. Create a model to answer the following question: *What are the top 10 customers by number of orders placed?*

28. Create a model to answer the following question: *How many items were sold by day?*

29. Delete the Google Project.

30. Delete the GitHub repository.

31. Delete your local dbt project folder.
